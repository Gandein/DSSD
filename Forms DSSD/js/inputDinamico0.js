...
dataType:"html",
//data:{solicitante: <solicitante>, fecha:<input->type="datetime-local">,participates: [<nombreParticipante>, <nombreParticipante2>,
//<nombreParticipante3>,<nombreParticipante4>,<nombreParticipante5>], motivo: <motivoConferencia>, numeroCausa: <numCausa> }
});
